...
import Logo from "../../assets/Grovegood_logo.png";

// icons
import { HiMenuAlt2, HiUserAdd} from "react-icons/hi";
          ...
          <div className="flex items-center justify-between  py-4 px-6 lg:px-16">
            ...
            <div>
              <NavLink
                ...
                to="/"
              >
                <img className="w-52 " style={{marginLeft:"-20px"}} src={Logo} alt="logo" />
              </NavLink>
            </div>
                      ...
                      >
                        <div className="py-1">
                          <div className="flex flex-col border-b border-slate-400 px-6 py-2">
                            <span className="text-base">Producer</span>
