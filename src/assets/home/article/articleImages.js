import cleansing from "./1.jpg";
import habits from "./2.jpg";
import changes from "./3.jpg";
import exp from "./4.jpg";
import shifts from "./5.jpg";
import fragrance from "./6.jpg";

export const articleImages = [
  {
    id: 0,
    img: cleansing,
    name: "Love Your Skin Again: Our Skincare Collection is a Pure Delight",
    description:
  ...
  },
  {
    id: 1,
    img: habits,
    name: "Embrace the Glow: Our Skincare Potions Work Magic on Your Skin",
    description:
  ...
  },
  {
    id: 2,
    img: changes,
    name: "Revitalize Your Life: Embrace the Nutritional Brilliance of Health Food",
    description:
  ...
  },
  {
    id: 3,
    img: exp,
    name: "Unleash Your Beauty: Elevate Your Skincare Routine!",
    description:
  ...
  },
  {
    id: 4,
    img: shifts,
    name: "Reveal Your Inner Glow: Transform Your Skincare Journey Today",
    description:
  ...
  },
  {
    id: 5,
    img: fragrance,
    name: "Skincare Enchantment: Experience the Magic of Our Natural Formulas",
    description:
