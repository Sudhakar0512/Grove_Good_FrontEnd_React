  ...
  reducers: {
    ...
    setAddItemToCartTwo: (state, action) => {
      ...
      if (itemIndex >= 0) {
        ...
        toast.success("Connetion Updated");
      } else {
    ...
    setPreAdd: (state, action) => {
      ...
      toast.success(`${action.payload.name} added to your Connection`);
    ...
    setRemoveItemFromCart: (state, action) => {
      ...
      toast.success(`${action.payload.name} removed from your Connection`);
