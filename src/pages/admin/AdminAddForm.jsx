...
export const AdminAddForm = () => {
  ...
  useEffect(() => {
    const url = "https://grove-good-backend.onrender.com/api/products/";
  ...
  return (
    <div className="max-h-[820px] overflow-y-auto border border-zinc-200 bg-green-200 p-5 shadow-md rounded-lg">
      ...
      >
        ...
        >
          <option value="">Farmer Product</option>
          <option>Amla</option>
          <option>Aloevera</option>
          <option>Banana</option>
          <option>Cocoa</option>
          <option>Coconut</option>
          <option>Coffee Seeds</option>
          <option>Dates</option>
          <option>Flax Seed</option>
          ...
          <div key={index}>
            <div className="mb-2 w-full space-y-6">
              ...
              <input
                ...
                placeholder="Address of the Farmer"
                className={
