...
import goodal from "../../../assets/about/Grove_good_v.mp4";
    ...
    <main className="min-h-screen w-full bg-bgcolor2">
      <div className="container mx-auto space-y-16 py-6 px-6 md:space-y-32 md:pb-32 lg:px-16">
        ...
        <div className="mt-20 flex flex-col items-center space-y-8">
          ...
          <p className="flex w-4/5 flex-col space-y-6 text-center font-gotu text-lg text-secondary md:text-2xl lhg:text-3xl">
            <span>GroveGood stands for some meaning</span>
            <span>
