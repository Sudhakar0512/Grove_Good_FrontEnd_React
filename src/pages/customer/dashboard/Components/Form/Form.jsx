...
function Form() {
    ...
    return (
        <FormStyled onSubmit={handleSubmit}>
            ...
            <div className="input-control">
                <textarea name="description" value={description} placeholder='Address of the Customer' id="description" cols="30" rows="4" onChange={handleInput('description')}></textarea>
            </div>
        <div>
            <h1> Add Bill</h1>
            <input
