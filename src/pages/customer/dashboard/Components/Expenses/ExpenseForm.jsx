        ...
        <ExpenseFormStyled onSubmit={handleSubmit}>
            ...
            <div className="selects input-control">
                <select required value={category} name="category" id="category" onChange={handleInput('category')}>
                    ...
                    <option value="Penuts">Penuts</option>
            ...
            <div className="input-control">
                <textarea name="description" value={description} placeholder='Add a Reference About the Product' id="description" cols="30" rows="4" onChange={handleInput('description')}></textarea>
            </div>
            <div className="input-control">
                <input 
                    type="text" 
                    value={title}
                    name={'title'} 
                    placeholder="Raw Materials Available"
